...
export const BundleProductComponentSchema = z.object({
  product_no: z.number().int().describe("Product number of component"),
  purchase_quantity: z.number().int().describe("Purchase quantity of component"),
  product_name: z.string().optional(),
  product_code: z.string().optional(),
  product_price: z.string().optional(),
});

export const BundleProductSalesSchema = z.object({
...
export const BundleProductSearchParamsSchema = z
  .object({
...
export const CreateBundleProductSchema = z
  .object({
...
export type BundleProductComponent = z.infer<typeof BundleProductComponentSchema>;
export type BundleProductSales = z.infer<typeof BundleProductSalesSchema>;
export type BundleProductSearchParams = z.infer<typeof BundleProductSearchParamsSchema>;
export type CreateBundleProduct = z.infer<typeof CreateBundleProductSchema>;
