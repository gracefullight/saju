...
export const metadata: Metadata = {
  ...
  description:
    "A robust Next.js 16 application demonstrating Cafe24 Admin integration with MCP (Model Context Protocol). Features secure authentication, modern UI, and comprehensive admin tools.",
